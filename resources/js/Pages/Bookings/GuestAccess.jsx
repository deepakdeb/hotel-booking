...
export default function GuestAccess() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('bookings.guest-access.submit'));
    };

    return (
        <GuestLayout>
            <Head title="Access Your Booking" />
                ...
                <div className="max-w-md w-full space-y-8">
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            >
                                {processing ? 'Accessing...' : 'Access Booking'}
                            </button>
                        </div>
                        ...
                        <div className="text-center">
                            <p className="text-sm text-gray-600">
                                ...
                                <a href={route('search')} className="font-medium text-indigo-600 hover:text-indigo-500">
                                    Search for hotels
                                </a>
                            </p>
                        </div>
